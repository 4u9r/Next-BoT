...
const CUSTOM_EMOJI =
'<a:970126883121410068:1516146900284211210>';


const BUTTON_EMOJI =
'<:emoji_1:1515707612048654426>';
...
async function createTranscript(channel){
    ...
    for(const msg of messages){
        ...
        text += `[${msg.author.tag}] : ${msg.content || "[embed]"}\n`;
...
return message.channel.send('✅ تم الإرسال');
...
return message.reply('✅ تم تشغيل الحالة');
