...
const SUPPORT_ROLE_ID = "1515031089406546041";

const CUSTOM_EMOJI = '1472545562468552735';
...
client.once('ready', async () => {
    ...
    const channel = client.channels.cache.get(AFK_VC_ID);
    if (channel) {
        joinVoiceChannel({
    ...
    setInterval(() => {
        client.user.setPresence({
            activities: [{ 
                name: toggle ? "By : Abu Yousef" : "سُبْحَانَ اللَّهِ وَبِحَمْدِهِ", 
