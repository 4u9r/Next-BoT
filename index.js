...
const BUTTON_ROOM_ID = '1515006381357531236';   // روم زر الرسالة الأساسية للتقييم
...
const AFK_VC_ID = "1458251157788033227";        // ايدي روم الـ AFK الصوتي

// 📩 تم ربط إيدي الكاتلوج المخصص للتكت هنا لفتحه تلقائياً بداخله
const TICKET_CATEGORY_ID = "1515024664328536155"; 

const CUSTOM_EMOJI = '1472545562468552735';     // ايدي الإيموجي المتحرك التلقائي على رسالة العميل
        ...
        if (interaction.isButton()) {
            ...
            if (interaction.customId === 'rules_server') {
                const textServer = `**__قوانين وشروط المتجر \n\n` +
                    ...
                    `2. جميع المنتجات والخدمات المقدمة رقمية، لذلك لا يمكن استرجاع أو استبدال المبلغ بعد إتمام عملية الدفع.\n` +
